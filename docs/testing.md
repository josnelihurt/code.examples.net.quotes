...
- **ServiceDefaults** — correlation middleware, metrics (all five counters), ErrorOr→ProblemDetails mapping, dev-key Production guard, host wiring (health/OpenAPI/Scalar in every environment)
