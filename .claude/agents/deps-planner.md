...
3. Flag every constraint you can state factually:
   - The **same-line rule**: the AppHost SDK pin and the `Aspire.Hosting.*` pins (including `Aspire.Hosting.Testing`) move together — one version line for all of them.
