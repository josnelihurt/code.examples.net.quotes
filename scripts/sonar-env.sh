...
export SONAR_PROJECT_KEY="${SONAR_PROJECT_KEY:-aspire-quotes-poc}"
export SONAR_PROJECT_NAME="${SONAR_PROJECT_NAME:-Aspire Quotes POC}"
...
export SONAR_ADMIN_PASSWORD="${SONAR_ADMIN_PASSWORD:-AspireQuotes-Poc1!}"
